        ...
        <section>
            ...
            <div class="about-grid">
                <div class="about-text">
                    ...
                    <p>
                        Bu site, JavaScript kullanılarak oluşturulmuş tek sayfalık (SPA) bir
                        portfolyo örneğidir. HTML5, CSS3 ve modern JavaScript (ES6+) ile
                        dinamik içerik yönetimi yapılmaktadır.
                    </p>
                    <div class="about-tags">
                        ...
                        <span class="tag">Responsive Tasarım</span>
                    </div>
                </div>
                <div>
                    <p><strong>İlgi Alanlarım</strong></p>
                    <ul>
                        <li>Ön yüz (frontend) geliştirme</li>
